...

            {
               ...
               ihevcd_update_ctb_tu_cnt(ps_proc);
                ...
                ps_proc->pu1_cur_ctb_luma = ps_proc->pu1_cur_pic_luma
                        + (ps_proc->i4_ctb_x * ctb_size + ps_proc->i4_ctb_y * ctb_size * ps_codec->i4_strd) *
                        ps_codec->i4_pixel_size_y;
                ps_proc->pu1_cur_ctb_chroma = ps_proc->pu1_cur_pic_chroma
                        + (ps_proc->i4_ctb_x * ctb_size
                        + ps_proc->i4_ctb_y * ctb_size * ps_codec->i4_strd / ps_codec->i4_sub_height_chroma) * ps_codec->i4_pixel_size_uv;
        ...
        while(num_ctb_tmp)
        {
            ...
            if(0 == FRAME_ILF_PAD || ps_codec->i4_num_cores != 1)
            {
                        ...
                        (ps_slice_hdr->i1_slice_sao_luma_flag || ps_slice_hdr->i1_slice_sao_chroma_flag))
                {
                    ...
                    pf_sao_ctb = (ftype_sao_ctb *)(ps_proc->s_sao_ctxt.pf_sao_ctb);
                ...
                /* Call padding if required */
                {
                    ...
                    if(0 == ps_proc->i4_ctb_x)
                    {
                        ...
                        ps_proc->pu1_cur_ctb_chroma = ps_proc->pu1_cur_pic_chroma
                                + (ps_proc->i4_ctb_x * ctb_size
                                + (ps_proc->i4_ctb_y * ctb_size * ps_codec->i4_strd / ps_codec->i4_sub_height_chroma)) *
                                        ps_codec->i4_pixel_size_uv;

                        pad_ht_luma = ctb_size;
                        pad_ht_luma += (ps_sps->i2_pic_ht_in_ctb - 1) == ps_proc->i4_ctb_y ? 8 : 0;
                        pad_ht_chroma = ctb_size / ps_codec->i4_sub_height_chroma;
                        ...
                        {
                            ps_codec->s_func_selector.ihevc_pad_left_chroma_fptr(ps_proc->pu1_cur_ctb_chroma - 16 * ps_codec->i4_strd,
                                ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                        }
                        else
                        {
                            ps_codec->s_func_selector.ihevc_hbd_pad_left_chroma_fptr((UWORD16 *)ps_proc->pu1_cur_ctb_chroma - 16 * ps_codec->i4_strd,
                                ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                        }
                    }
                    ...
                    if((ps_sps->i2_pic_wd_in_ctb - 1) == ps_proc->i4_ctb_x)
                    {
                        ...
                        if((ps_sps->i2_pic_ht_in_ctb - 1) == ps_proc->i4_ctb_y )
                        {
                            ...
                            if (1 == ps_codec->i4_pixel_size_uv)
                            {
                                ps_codec->s_func_selector.ihevc_pad_left_chroma_fptr(
                                    ps_proc->pu1_cur_pic_chroma +
                                    (ps_sps->i2_pic_height_in_luma_samples / ps_codec->i4_sub_height_chroma - 16) * ps_codec->i4_strd,
                                    ps_codec->i4_strd, 16, PAD_LEFT);
                            }
                            else
                            {
                                ps_codec->s_func_selector.ihevc_hbd_pad_left_chroma_fptr(
                                    (UWORD16 *)ps_proc->pu1_cur_pic_chroma +
                                    (ps_sps->i2_pic_height_in_luma_samples/ps_codec->i4_sub_height_chroma - 16) *
                                    ps_codec->i4_strd,
                                    ps_codec->i4_strd, 16, PAD_LEFT);
                            }
                        }
                        ...
                        {
                            ihevc_hbd_pad_right_chroma((UWORD16 *)ps_proc->pu1_cur_ctb_chroma + cols_remaining - 16 * ps_codec->i4_strd,
                                ps_codec->i4_strd, pad_ht_chroma, PAD_RIGHT);
                        }
                        ...
                        if((ps_sps->i2_pic_ht_in_ctb - 1) == ps_proc->i4_ctb_y)
                        {
                            ...
                            if (1 == ps_codec->i4_pixel_size_uv)
                            {
                                ihevc_pad_top(ps_proc->pu1_cur_pic_chroma - PAD_LEFT, ps_codec->i4_strd,
                                    ps_sps->i2_pic_width_in_luma_samples + PAD_WD, PAD_TOP / ps_codec->i4_sub_height_chroma);
                            }
                            else
                            {
                                ihevc_hbd_pad_top((UWORD16 *)ps_proc->pu1_cur_pic_chroma - PAD_LEFT, ps_codec->i4_strd,
                                    ps_sps->i2_pic_width_in_luma_samples + PAD_WD, PAD_TOP / ps_codec->i4_sub_height_chroma);
                            }
                            ...
                            pu1_buf = ps_proc->pu1_cur_pic_chroma +
                                (ps_codec->i4_strd * (ps_sps->i2_pic_height_in_luma_samples / ps_codec->i4_sub_height_chroma) - PAD_LEFT) *
                                    ps_codec->i4_pixel_size_uv;
                            if (1 == ps_codec->i4_pixel_size_uv)
                            {
                                ihevc_pad_bottom(pu1_buf, ps_codec->i4_strd,
                                    ps_sps->i2_pic_width_in_luma_samples + PAD_WD, PAD_BOT / ps_codec->i4_sub_height_chroma);
                            }
                            else
                            {
                                ihevc_hbd_pad_bottom((UWORD16 *)pu1_buf, ps_codec->i4_strd,
                    ...
                    if(ps_proc->i4_ctb_y > 1)
                    {
                        if(0 == ps_proc->i4_ctb_x)
                        {
                            ...
                            if (1 == ps_codec->i4_pixel_size_y)
                            {
                                ps_codec->s_func_selector.ihevc_pad_left_luma_fptr(
                                    ps_proc->pu1_cur_ctb_luma - 2 * ctb_size * ps_codec->i4_strd,
                                    ps_codec->i4_strd, pad_ht_luma, PAD_LEFT);
                            }
                            else
                            {
                                ps_codec->s_func_selector.ihevc_hbd_pad_left_luma_fptr((UWORD16 *)ps_proc->pu1_cur_ctb_luma - 2 * ctb_size * ps_codec->i4_strd,
                                                        ps_codec->i4_strd, pad_ht_luma, PAD_LEFT);
                            }
                            if (1 == ps_codec->i4_pixel_size_uv)
                            {
                                ps_codec->s_func_selector.ihevc_pad_left_chroma_fptr(
                                    ps_proc->pu1_cur_ctb_chroma - ctb_size * ps_codec->i4_strd,
                                    ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                            }
                            else
                            {
                                ps_codec->s_func_selector.ihevc_hbd_pad_left_chroma_fptr((UWORD16 *)ps_proc->pu1_cur_ctb_chroma - ctb_size * ps_codec->i4_strd,
                                                          ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                            }
                        }
                        else if((ps_sps->i2_pic_wd_in_ctb - 1) == ps_proc->i4_ctb_x)
                        {
                            ...
                            pad_ht_chroma =
                                ((ps_sps->i2_pic_ht_in_ctb - 1) == ps_proc->i4_ctb_y) ?
                                3 * ctb_size / ps_codec->i4_sub_height_chroma : ctb_size / ps_codec->i4_sub_height_chroma;
                            /* Pad right after last CTB in the current row is processed */
                            if (1 == ps_codec->i4_pixel_size_y)
                            {
                                ps_codec->s_func_selector.ihevc_pad_right_luma_fptr(
                                    ps_proc->pu1_cur_ctb_luma + cols_remaining - 2 * ctb_size * ps_codec->i4_strd,
                                    ps_codec->i4_strd, pad_ht_luma, PAD_RIGHT);
                            }
                            else
                            {
                                ps_codec->s_func_selector.ihevc_hbd_pad_right_luma_fptr(
                                    (UWORD16 *)ps_proc->pu1_cur_ctb_luma + cols_remaining - 2 * ctb_size * ps_codec->i4_strd,
                                    ps_codec->i4_strd, pad_ht_luma, PAD_RIGHT);
                            }
                            if (1 == ps_codec->i4_pixel_size_uv)
                            {
                            ...
                            else
                            {
                                ihevc_hbd_pad_right_chroma(
                                    (UWORD16 *)ps_proc->pu1_cur_ctb_chroma + cols_remaining - ctb_size * ps_codec->i4_strd,
                                    ps_codec->i4_strd, pad_ht_chroma, PAD_RIGHT);
                            }
                            ...
                            if((ps_sps->i2_pic_ht_in_ctb - 1) == ps_proc->i4_ctb_y)
                            {
                                ...
                                pad_ht_chroma = pad_ht_luma / ps_codec->i4_sub_height_chroma;

                                if (1 == ps_codec->i4_pixel_size_y)
                                {
                                    ps_codec->s_func_selector.ihevc_pad_left_luma_fptr(
                                        ps_proc->pu1_cur_pic_luma + ps_codec->i4_strd * (ps_sps->i2_pic_height_in_luma_samples - 2 * ctb_size),
                                        ps_codec->i4_strd, pad_ht_luma, PAD_LEFT);
                                }
                                else
                                {
                                    ps_codec->s_func_selector.ihevc_hbd_pad_left_luma_fptr(
                                        (UWORD16 *)ps_proc->pu1_cur_pic_luma + ps_codec->i4_strd *
                                        (ps_sps->i2_pic_height_in_luma_samples - 2 * ctb_size),
                                        ps_codec->i4_strd, pad_ht_luma, PAD_LEFT);
                                }
                                if (1 == ps_codec->i4_pixel_size_uv)
                                {
                                    ps_codec->s_func_selector.ihevc_pad_left_chroma_fptr(
                                        ps_proc->pu1_cur_pic_chroma + ps_codec->i4_strd *
                                        (ps_sps->i2_pic_height_in_luma_samples / ps_codec->i4_sub_height_chroma - ctb_size),
                                        ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                                }
                                else
                                {
                                    ps_codec->s_func_selector.ihevc_hbd_pad_left_chroma_fptr(
                                        (UWORD16 *)ps_proc->pu1_cur_pic_chroma + ps_codec->i4_strd *
                                        (ps_sps->i2_pic_height_in_luma_samples / ps_codec->i4_sub_height_chroma - ctb_size),
                                        ps_codec->i4_strd, pad_ht_chroma, PAD_LEFT);
                                }
                                ...
                                {
                                    ihevc_hbd_pad_top((UWORD16 *)_proc->pu1_cur_pic_chroma - PAD_LEFT, ps_codec->i4_strd,
                                        ps_sps->i2_pic_width_in_luma_samples + PAD_WD, PAD_TOP / ps_codec->i4_sub_height_chroma);
                                }
