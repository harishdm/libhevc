...
const pf_hbd_itrans_recon gafp_ihevcd_hbd_itrans_recon_sse42[] =
{
    (pf_hbd_itrans_recon)&ihevc_hbd_itrans_recon_4x4_ttype1_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_itrans_recon_4x4_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_itrans_recon_8x8_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_itrans_recon_16x16_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_itrans_recon_32x32_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_chroma_itrans_recon_4x4_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_chroma_itrans_recon_8x8_sse42,
    (pf_hbd_itrans_recon)&ihevc_hbd_chroma_itrans_recon_16x16_sse42
};

const pf_hbd_intra_pred_luma gafp_ihevcd_hbd_intra_pred_luma_sse42[] =
{
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_planar,//_sse42, For 12 bit
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_planar,//_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_dc_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode2_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode_3_to_9_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_horz_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode_11_to_17_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode_18_34_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode_19_to_25_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_ver_sse42,
    (pf_hbd_intra_pred_luma)&ihevc_hbd_intra_pred_luma_mode_27_to_33_sse42
};

const pf_hbd_intra_pred_chroma gafp_ihevcd_hbd_intra_pred_chroma_sse42[] =
{
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_planar_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_planar_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_dc_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode2_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode_3_to_9_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_horz_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode_11_to_17_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode_18_34_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode_19_to_25_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_ver_sse42,
    (pf_hbd_intra_pred_chroma)&ihevc_hbd_intra_pred_chroma_mode_27_to_33_sse42
};

const pf_hbd_sao_luma gapf_hbd_sao_luma_sse42[] =
{
    (pf_hbd_sao_luma)&ihevc_hbd_sao_edge_offset_class0_sse42,
    (pf_hbd_sao_luma)&ihevc_hbd_sao_edge_offset_class1_sse42,
    (pf_hbd_sao_luma)&ihevc_hbd_sao_edge_offset_class2_sse42,
    (pf_hbd_sao_luma)&ihevc_hbd_sao_edge_offset_class3_sse42
};

const pf_hbd_sao_chroma gapf_hbd_sao_chroma_sse42[] =
{
    (pf_hbd_sao_chroma)&ihevc_hbd_sao_edge_offset_class0_chroma_sse42,
    (pf_hbd_sao_chroma)&ihevc_hbd_sao_edge_offset_class1_chroma_sse42,
    (pf_hbd_sao_chroma)&ihevc_hbd_sao_edge_offset_class2_chroma_sse42,
    (pf_hbd_sao_chroma)&ihevc_hbd_sao_edge_offset_class3_chroma_sse42
};

const pf_hbd_inter_pred gapf_hbd_inter_pred_sse42[22] =
 {
      NULL,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_copy_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_vert_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_horz_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_horz_w16out_sse42,

      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_copy_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_vert_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_horz_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_horz_w16out_sse42,

      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_vert_w16inp_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_luma_vert_w16inp_w16out_sse42,

      NULL,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_copy_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_vert_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_horz_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_horz_w16out_sse42,

      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_copy_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_vert_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_horz_w16out_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_horz_w16out_sse42,

      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_vert_w16inp_sse42,
      (pf_hbd_inter_pred)&ihevc_hbd_inter_pred_chroma_vert_w16inp_w16out_sse42
};
