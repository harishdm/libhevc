...
void ihevcd_init_function_ptr_noneon(codec_t *ps_codec)
{
        ...
        ps_codec->s_func_selector.ppv_ihevcd_hbd_intra_pred_luma                    = (void **)gafp_ihevcd_hbd_intra_pred_luma;
        ps_codec->s_func_selector.ppv_ihevcd_hbd_intra_pred_chroma                  = (void **)gafp_ihevcd_hbd_intra_pred_chroma;
        ...
        ps_codec->s_func_selector.ppv_ihevcd_hbd_sao_luma                           = (void **)gapf_hbd_sao_luma;
        ...
        ps_codec->s_func_selector.ppv_ihevcd_hbd_inter_pred                         = (void **)gapf_hbd_inter_pred;
        ps_codec->s_func_selector.pf_hbd_wt_pred_uni                                = &ihevc_hbd_weighted_pred_uni;
        ps_codec->s_func_selector.pf_hbd_wt_pred_bi                                 = &ihevc_hbd_weighted_pred_bi;
        ps_codec->s_func_selector.pf_hbd_wt_pred_bi_dflt                            = &ihevc_hbd_weighted_pred_bi_default;
        ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_uni                           = &ihevc_hbd_weighted_pred_chroma_uni;
        ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_bi                            = &ihevc_hbd_weighted_pred_chroma_bi;
