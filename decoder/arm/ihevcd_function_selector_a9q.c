...
void ihevcd_init_function_ptr_a9q(codec_t *ps_codec)
{
        ...
        ps_codec->s_func_selector.ppv_ihevcd_hbd_itrans_recon                       = (void **)gafp_ihevcd_hbd_itrans_recon;
        ps_codec->s_func_selector.ihevc_hbd_pad_left_luma_fptr                      = &ihevc_hbd_pad_left_luma;
        ps_codec->s_func_selector.ihevc_hbd_pad_right_luma_fptr                     = &ihevc_hbd_pad_right_luma;
        ps_codec->s_func_selector.ihevc_hbd_pad_left_chroma_fptr                    = &ihevc_hbd_pad_left_chroma;
        ps_codec->s_func_selector.ppv_ihevcd_hbd_sao_luma                           = (void **)gapf_hbd_sao_luma_a9q;
        ps_codec->s_func_selector.ppv_ihevcd_hbd_inter_pred                         = (void **)gapf_hbd_inter_pred_a9q;
        ps_codec->s_func_selector.ppv_ihevcd_hbd_intra_pred_chroma                  = (void **)gafp_ihevcd_hbd_intra_pred_chroma_a9q;
        ps_codec->s_func_selector.ppv_ihevcd_hbd_intra_pred_luma                    = (void **)gafp_ihevcd_hbd_intra_pred_luma_a9q;
        ps_codec->s_func_selector.pf_hbd_wt_pred_uni                                = &ihevc_hbd_weighted_pred_uni_a9q;
        ps_codec->s_func_selector.pf_hbd_wt_pred_bi                                 = &ihevc_hbd_weighted_pred_bi_a9q;
        ps_codec->s_func_selector.pf_hbd_wt_pred_bi_dflt                            = &ihevc_hbd_weighted_pred_bi_default;
        ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_uni                           = &ihevc_hbd_weighted_pred_chroma_uni_a9q;
        ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_bi                            = &ihevc_hbd_weighted_pred_chroma_bi_a9q;
        ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_bi_dflt                       = &ihevc_hbd_weighted_pred_chroma_bi_default;
        ps_codec->s_func_selector.pf_hbd_deblk_luma_vert                            = &ihevc_hbd_deblk_luma_vert_neonintr;
