...
void ihevcd_inter_pred_ctb(process_ctxt_t *ps_proc)
{
    ...
    for(pu_indx = 0; pu_indx < i4_pu_cnt; pu_indx++, ps_pu++)
    {
        ...
        if(ps_pu->b2_pred_mode != PRED_L1)
        {
            ...
            luma_offset_l0 =
                ps_wt_ofst->i2_luma_offset_l0[ps_pu->mv.i1_l0_ref_idx] * (1 << (i4_bit_depth_luma - 8));
            chroma_offset_l0_cb =
                ps_wt_ofst->i2_chroma_offset_l0_cb[ps_pu->mv.i1_l0_ref_idx] * (1 << (i4_bit_depth_chroma - 8));
            chroma_offset_l0_cr =
                ps_wt_ofst->i2_chroma_offset_l0_cr[ps_pu->mv.i1_l0_ref_idx] * (1 << (i4_bit_depth_chroma - 8));
        }
        ...
        if(ps_pu->b2_pred_mode != PRED_L0)
        {
            ...
            luma_offset_l1 =
                ps_wt_ofst->i2_luma_offset_l1[ps_pu->mv.i1_l1_ref_idx] * (1 << (i4_bit_depth_luma - 8));
            chroma_offset_l1_cb =
                ps_wt_ofst->i2_chroma_offset_l1_cb[ps_pu->mv.i1_l1_ref_idx] * (1 << (i4_bit_depth_chroma - 8));
            chroma_offset_l1_cr =
                ps_wt_ofst->i2_chroma_offset_l1_cr[ps_pu->mv.i1_l1_ref_idx] * (1 << (i4_bit_depth_chroma - 8));
        }
        ...
        for(clr_indx = 0; clr_indx < 2; clr_indx++)
        {
            ...
            else
            {
                ...
                if(ps_pu->b2_pred_mode != PRED_L1)
                {
                    ...
                    mv = CLIP3((ps_pu->mv.s_l0_mv.i2_mvy*2/i4_sub_ht_c), ((-((MAX_CTB_SIZE + pu_y + 7) << 2))*2/i4_sub_ht_c),
                                (((ps_sps->i2_pic_height_in_luma_samples - pu_y + 7) << 2)*2/i4_sub_ht_c));
                    ai2_yint[0] = pu_y / i4_sub_ht_c + (mv >> 3);
                    ai2_yfrac[0] = mv & 7;

                    ref_pic_l0 = ref_pic_chroma_l0 + (ai2_yint[0] * ref_strd
                                        + ai2_xint[0]) * i4_pixel_size_uv;
                    ai2_xfrac[0] &= ps_codec->i4_mv_frac_mask;
                    ai2_yfrac[0] &= ps_codec->i4_mv_frac_mask;
                }
                ...
                if(ps_pu->b2_pred_mode != PRED_L0)
                {
                    ...
                    mv = CLIP3((ps_pu->mv.s_l1_mv.i2_mvy*2/i4_sub_ht_c), ((-((MAX_CTB_SIZE + pu_y + 7) << 2))*2/i4_sub_ht_c),
                                (((ps_sps->i2_pic_height_in_luma_samples - pu_y + 7) << 2)*2/i4_sub_ht_c));
                    ai2_yint[1] = pu_y / i4_sub_ht_c + (mv >> 3);
                    ai2_yfrac[1] = mv & 7;

                    ref_pic_l1 = ref_pic_chroma_l1 + (ai2_yint[1] * ref_strd
                                        + ai2_xint[1]) * i4_pixel_size_uv;
                    ai2_xfrac[1] &= ps_codec->i4_mv_frac_mask;
                    ai2_yfrac[1] &= ps_codec->i4_mv_frac_mask;
                }

                pu1_dst = pu1_dst_chroma + (pu_y * ref_strd / i4_sub_ht_c + pu_x) * i4_pixel_size_uv;
            ...
            if((weighted_pred != 0) && (bi_pred != 0))
            {
                ...
                else
                {
                    ...
                    shift = ps_wt_ofst->i1_chroma_log2_weight_denom
                                    + (14 - i4_bit_depth_chroma) + 1; //+ SHIFT_14_MINUS_BIT_DEPTH + 1;
                    i4_pu_ht_c = pu_ht >> 1;
                    ...
                    if(chroma_yuv420sp_vu)
                    {
                        if (1 == i4_pixel_size_uv)
                        {
                            ps_codec->s_func_selector.ihevc_weighted_pred_chroma_bi_fptr(pi2_tmp1,
                                                                        pi2_tmp2,pu1_dst,
                                                                        pu_wd,pu_wd,ref_strd,
                                                                        chroma_weight_l0_cr,chroma_weight_l0_cb,
                                                                        chroma_offset_l0_cr,chroma_offset_l0_cb,
                                                                        chroma_weight_l1_cr,chroma_weight_l1_cb,
                                                                        chroma_offset_l1_cr,chroma_offset_l1_cb,
                                                                        shift,lvl_shift1,lvl_shift2,
                                                                        i4_pu_ht_c,pu_wd >> 1);
                        }
                        else
                        {
                            ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_bi(pi2_tmp1,pi2_tmp2,(UWORD16 *)pu1_dst,
                                                              pu_wd,pu_wd,ref_strd,
                                                              chroma_weight_l0_cr,chroma_weight_l0_cb,
                                                              chroma_offset_l0_cr,chroma_offset_l0_cb,
                                                              chroma_weight_l1_cr,chroma_weight_l1_cb,
                    ...
                    else
                    {
                        if (1 == i4_pixel_size_uv)
                        {
                            ps_codec->s_func_selector.ihevc_weighted_pred_chroma_bi_fptr(pi2_tmp1,
                                                                        pi2_tmp2,pu1_dst,
                                                                        pu_wd,pu_wd,ref_strd,
                                                                        chroma_weight_l0_cb,chroma_weight_l0_cr,
                                                                        chroma_offset_l0_cb,chroma_offset_l0_cr,
                                                                        chroma_weight_l1_cb,chroma_weight_l1_cr,
                                                                        chroma_offset_l1_cb,chroma_offset_l1_cr,
                                                                        shift,lvl_shift1,lvl_shift2,
                                                                        i4_pu_ht_c,pu_wd >> 1);
                        }
                        else
                ...
                } /* End of chroma weighted bi pred */
            ...
            else if((weighted_pred != 0) && (bi_pred == 0))
            {
                ...
                else
                {
                    ...
                    shift = ps_wt_ofst->i1_chroma_log2_weight_denom
                                    + 14 - i4_bit_depth_chroma; //+ SHIFT_14_MINUS_BIT_DEPTH;
                    ...
                    if(chroma_yuv420sp_vu)
                    {
                        ...
                        else
                        {
                            ps_codec->s_func_selector.pf_hbd_wt_pred_chrm_uni(ps_pu->b2_pred_mode == PRED_L0 ? pi2_tmp1 : pi2_tmp2,
                                                       ...
                                                       ps_pu->b2_pred_mode == PRED_L0 ? chroma_offset_l0_cr : chroma_offset_l1_cr,
                                                       ps_pu->b2_pred_mode == PRED_L0 ? chroma_offset_l0_cb : chroma_offset_l1_cb,
                                                       shift,lvl_shift1,i4_pu_ht_c,pu_wd >> 1,(UWORD8)i4_bit_depth_chroma);
                        }
                    }
                    else
                    {
            ...
            else if((weighted_pred == 0) && (bi_pred != 0))
            {
                ...
                {
                    ps_codec->s_func_selector.pf_hbd_wt_pred_bi_dflt(pi2_tmp1,pi2_tmp2,(UWORD16 *)pu1_dst,
                                                       pu_wd,pu_wd,ref_strd,
                                                       lvl_shift1,lvl_shift2,
                                                       pu_ht,pu_wd,u1_bit_depth);
                }
            } /* End of if bi pred */
