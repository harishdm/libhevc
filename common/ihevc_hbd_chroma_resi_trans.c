...
void ihevc_hbd_chroma_resi_trans_4x4(UWORD16 *pu2_src,
                                 UWORD16 *pu2_pred,
                                 WORD16 *pi2_tmp,
                                 WORD16 *pi2_dst,
                                 WORD32 i4_src_strd,
...
void ihevc_hbd_chroma_resi_trans_8x8(UWORD16 *pu2_src,
                                 UWORD16 *pu2_pred,
                                 WORD16 *pi2_tmp,
                                 WORD16 *pi2_dst,
                                 WORD32 i4_src_strd,
...
void ihevc_hbd_chroma_resi_trans_16x16(UWORD16 *pu2_src,
                                   UWORD16 *pu2_pred,
                                   WORD16 *pi2_tmp,
                                   WORD16 *pi2_dst,
                                   WORD32 i4_src_strd,
