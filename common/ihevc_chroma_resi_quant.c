...
void ihevc_chroma_resi_quant_4x4(UWORD8 *pu1_src,
                                 UWORD8 *pu1_pred,
                                 ...
                                 WORD32 *csbf)
{
    ...
    for(i = 0; i < trans_size; i++)
    {
        for(j = 0; j < trans_size; j++)
        {
            ...
            residue = (pu1_src[j * 2] - pu1_pred[j * 2]);
...
void ihevc_chroma_resi_quant_8x8(UWORD8 *pu1_src,
                                 UWORD8 *pu1_pred,
                                 WORD16 *pi2_quant_coeff,
                                 WORD16 *pi2_dst,
                                 WORD32 qp_div,/* qpscaled / 6 */
...
void ihevc_chroma_resi_quant_16x16(UWORD8 *pu1_src,
                                   UWORD8 *pu1_pred,
                                   WORD16 *pi2_quant_coeff,
                                   WORD16 *pi2_dst,
                                   WORD32 qp_div,/* qpscaled / 6 */
