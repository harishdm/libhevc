 ...
 *******************************************************************************
 */
void ihevc_hbd_iquant_itrans_recon_32x32(WORD16 *pi2_src,
                                     WORD16 *pi2_tmp,
                                     UWORD16 *pu2_pred,
    ...
    if((i4_zero_rows & 0xFFFFFFF0) == 0xFFFFFFF0)  /* First 4 rows of input are non-zero */
    {
        ...
        for(j = 0; j < row_limit_2nd_stage; j++)
        {
            ...
            else
            {
                ...
                {
                    IQUANT(iq_tmp_1,
                           pi2_src[1*i4_src_strd],
                           pi2_dequant_coeff[1*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_2,
                           pi2_src[3*i4_src_strd],
                           pi2_dequant_coeff[3*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                {
                    IQUANT(iq_tmp_1,
                           pi2_src[2*i4_src_strd],
                           pi2_dequant_coeff[2*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                IQUANT(iq_tmp_1,
                       pi2_src[0*i4_src_strd],
                       pi2_dequant_coeff[0*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                       shift_iq, i4_qp_div);
            ...
            else
            {
                ...
                for(k = 0; k < 16; k++)
                {
                    ...
                    IQUANT(iq_tmp_3,
                           ...
                           pi2_dequant_coeff[5*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_4,
                           pi2_src[7*i4_src_strd],
                           pi2_dequant_coeff[7*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                for(k = 0; k < 8; k++)
                {
                    ...
                    IQUANT(iq_tmp_2,
                           ...
                           pi2_dequant_coeff[6*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                {
                    IQUANT(iq_tmp_1,
                           pi2_src[4*i4_src_strd],
                           pi2_dequant_coeff[4*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
            ...
            else
            {
                ...
                for(k = 0; k < 16; k++)
                {
                    ...
                    IQUANT(iq_tmp_5,
                           ...
                           pi2_dequant_coeff[9*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_6,
                           pi2_src[11*i4_src_strd],
                           pi2_dequant_coeff[11*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_7,
                           pi2_src[13*i4_src_strd],
                           pi2_dequant_coeff[13*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_8,
                           pi2_src[15*i4_src_strd],
                           pi2_dequant_coeff[15*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_9,
                           pi2_src[17*i4_src_strd],
                           pi2_dequant_coeff[17*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_10,
                           pi2_src[19*i4_src_strd],
                           pi2_dequant_coeff[19*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_11,
                           pi2_src[21*i4_src_strd],
                           pi2_dequant_coeff[21*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_12,
                           pi2_src[23*i4_src_strd],
                           pi2_dequant_coeff[23*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_13,
                           pi2_src[25*i4_src_strd],
                           pi2_dequant_coeff[25*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_14,
                           pi2_src[27*i4_src_strd],
                           pi2_dequant_coeff[27*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_15,
                           pi2_src[29*i4_src_strd],
                           pi2_dequant_coeff[29*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_16,
                           pi2_src[31*i4_src_strd],
                           pi2_dequant_coeff[31*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                for(k = 0; k < 8; k++)
                {
                    ...
                    IQUANT(iq_tmp_3,
                           ...
                           pi2_dequant_coeff[10*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_4,
                           pi2_src[14*i4_src_strd],
                           pi2_dequant_coeff[14*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_5,
                           pi2_src[18*i4_src_strd],
                           pi2_dequant_coeff[18*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_6,
                           pi2_src[22*i4_src_strd],
                           pi2_dequant_coeff[22*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_7,
                           pi2_src[26*i4_src_strd],
                           pi2_dequant_coeff[26*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_8,
                           pi2_src[30*i4_src_strd],
                           pi2_dequant_coeff[30*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                for(k = 0; k < 4; k++)
                {
                    ...
                    IQUANT(iq_tmp_2,
                           ...
                           pi2_dequant_coeff[12*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_3,
                           pi2_src[20*i4_src_strd],
                           pi2_dequant_coeff[20*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                    IQUANT(iq_tmp_4,
                           pi2_src[28*i4_src_strd],
                           pi2_dequant_coeff[28*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                           shift_iq, i4_qp_div);
                ...
                IQUANT(iq_tmp_1,
                       ...
                       pi2_dequant_coeff[8*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                       shift_iq, i4_qp_div);
                IQUANT(iq_tmp_2,
                       pi2_src[24*i4_src_strd],
                       pi2_dequant_coeff[24*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                       shift_iq, i4_qp_div);
                ...
                IQUANT(iq_tmp_2,
                       ...
                       pi2_dequant_coeff[16*trans_size] *g_ihevc_iquant_scales[i4_qp_rem],
                       shift_iq, i4_qp_div);
