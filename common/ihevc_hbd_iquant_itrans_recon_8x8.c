 ...
 *******************************************************************************
 * @file
 *  ihevc_iquant_itrans_recon_8x8.c
 *
 * @brief
 *  Contains function definitions for inverse  quantization, inverse
 * transform and reconstruction 8x8
 *
 * @author
 *  Ittiam
 *
...
void ihevc_hbd_iquant_itrans_recon_8x8(WORD16 *pi2_src,
                                   WORD16 *pi2_tmp,
                                   UWORD16 *pu2_pred,
                                   ...
                                   UWORD8 u1_bit_depth)
{
    ...
    if((i4_zero_rows & 0xF0) == 0xF0) /* Only First 4 rows of input are non-zero */
    {
        /************************************************************************************************/
        /**********************************START - IT_RECON_8x8******************************************/
        /************************************************************************************************/
