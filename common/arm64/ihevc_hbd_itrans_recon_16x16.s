...
.globl ihevc_hbd_itrans_recon_16x16_av8

.extern g_ai2_ihevc_trans_16_transpose

.type ihevc_hbd_itrans_recon_16x16_av8, %function

ihevc_hbd_itrans_recon_16x16_av8:
...
//    registers free: q8,q14,q12,q13
    ...
    ld1         {v16.8h, v17.8h},[x2],x8
    ld1         {v28.8h, v29.8h},[x2],x8
    ld1         {v24.8h, v25.8h},[x2],x8
    ld1         {v26.8h, v27.8h},[x2],x8
    ...
    smin v22.8h, v22.8h, v31.8h
    smin v12.8h, v12.8h, v31.8h
    smin v30.8h, v30.8h, v31.8h
    smin v18.8h, v18.8h, v31.8h
    smin v14.8h, v14.8h, v31.8h
    smin v20.8h, v20.8h, v31.8h
    smin v8.8h, v8.8h, v31.8h

    mov w5, #0
    dup v31.8h, w5
    smax v4.8h, v4.8h, v31.8h
    smax v22.8h, v22.8h, v31.8h
    smax v12.8h, v12.8h, v31.8h
    smax v30.8h, v30.8h, v31.8h
    smax v18.8h, v18.8h, v31.8h
    smax v14.8h, v14.8h, v31.8h
    smax v20.8h, v20.8h, v31.8h
    smax v8.8h, v8.8h, v31.8h
