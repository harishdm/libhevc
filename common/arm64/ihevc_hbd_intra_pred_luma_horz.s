...
.globl ihevc_hbd_inter_pred_luma_horz_av8

.type ihevc_hbd_inter_pred_luma_horz_av8, %function

ihevc_hbd_inter_pred_luma_horz_av8:
...
#
#    mov          w4, #1023
#    dup          v23.4h,w4               // max1023_16x4 = vdup_n_u16(1023);
...
inner_loop_4:
    ...
    sqrshrun    v20.4h, v8.4s,#6            //right shift and saturating narrow result  vqrshrun_n_s32(mul_res_32x4_r0_0, 6);
    sqrshrun    v8.4h, v10.4s,#6            //right shift and saturating narrow result 2

    umin        v20.4h,v20.4h,v23.4h           //vmin_u16(mul_res_16x4_r0_0, max1023_16x4);
    umin        v8.4h,v8.4h,v23.4h           //vmin_u16(mul_res_16x4_r0_0, max1023_16x4);
...
inner_loop_8:
    ...
    sqrshrun    v8.4h,  v14.4s, #6
    sqrshrun    v20.4h, v15.4s, #6
    umin        v8.4h,  v8.4h,  v23.4h
    umin        v20.4h, v20.4h, v23.4h
    st1         {v8.4h}, [x1],#8
    st1         {v20.4h},[x1],#8
