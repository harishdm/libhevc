...
//    stp         x19, x20,[sp,#-16]!
    ...
    subs        x7,x3,#0                            //x3->ht
    sxtl        v0.8h, v0.8b
    dup         v22.8h, v0.h[0]                     //coeffabs_0 = vdup_lane_u8(coeffabs, 0)//
    dup         v23.8h, v0.h[1]                     //coeffabs_1 = vdup_lane_u8(coeffabs, 1)//
    dup         v24.8h, v0.h[2]                     //coeffabs_2 = vdup_lane_u8(coeffabs, 2)//
    dup         v25.8h, v0.h[3]                     //coeffabs_3 = vdup_lane_u8(coeffabs, 3)//
    dup         v26.8h, v0.h[4]                     //coeffabs_4 = vdup_lane_u8(coeffabs, 4)//
    dup         v27.8h, v0.h[5]                     //coeffabs_5 = vdup_lane_u8(coeffabs, 5)//
    dup         v28.8h, v0.h[6]                     //coeffabs_6 = vdup_lane_u8(coeffabs, 6)//
    dup         v29.8h, v0.h[7]                     //coeffabs_7 = vdup_lane_u8(coeffabs, 7)//

    sub         x10,x5,x6,lsl #2                    //x6->dst_strd    x5    ->wd
    neg         x9, x10
    sub         x10,x5,x2,lsl #2                    //x2->src_strd
    neg         x8, x10
    sub         x8,x8,x5
...
kernel_8:
    ...
    add         x3,x0,x2                            //pu1_src_tmp += src_strd//
    smlal       v21.4s, v6.4h, v26.4h
    ld1         {v1.8h},[x3],x2                     //src_tmp2 = vld1_u8(pu1_src_tmp)//
    add         x14,x1,x6
    smlal       v21.4s, v7.4h, v27.4h
    smlal       v21.4s, v16.4h, v28.4h
    ld1         {v0.8h},[x0]                        //src_tmp1 = vld1_u8(pu1_src_tmp)//
    add         x0,x0,#8
    smlal       v21.4s, v17.4h, v29.4h
    sqshrn      v20.4h, v20.4s,#6
    sqrshrun    v19.8b, v19.8h,#6                   //sto_res = vqmovun_s16(sto_res_tmp)//
    ...
    smull       v30.4s, v4.4h, v23.4h
    smlal       v30.4s, v3.4h, v22.4h
    ld1         {v2.8h},[x3],x2                     //src_tmp3 = vld1_u8(pu1_src_tmp)//
    smlal       v30.4s, v5.4h, v24.4h
    smlal       v30.4s, v6.4h, v25.4h
    ld1         {v3.8h},[x3],x2                     //src_tmp4 = vld1_u8(pu1_src_tmp)//
    smlal       v30.4s, v7.4h, v26.4h
    ld1         {v4.8h},[x3],x2                     //src_tmp1 = vld1_u8(pu1_src_tmp)//
    st1         {v19.s}[0],[x1],#4                  //vst1_u8(pu1_dst,sto_res)//
    smlal       v30.4s, v16.4h, v27.4h
    ld1         {v5.8h},[x3],x2                     //src_tmp2 = vld1_u8(pu1_src_tmp)//
    add         x10,x1,x9
    smlal       v30.4s, v17.4h, v28.4h
    ld1         {v6.8h},[x3],x2                     //src_tmp3 = vld1_u8(pu1_src_tmp)//
    csel        x1, x10, x1,le
    smlal       v30.4s, v18.4h, v29.4h
    ld1         {v7.8h},[x3],x2                     //src_tmp4 = vld1_u8(pu1_src_tmp)//
    sqshrn      v21.4h, v21.4s,#6
    lsr         x13,x5,#3
    sqrshrun    v20.8b, v20.8h,#6                   //sto_res = vqmovun_s16(sto_res_tmp)//

    cmp         x13,#2
    bge         start_kernel_8_element

    subs        x7,x7,#4
    bgt         kernel_8                            //jumps to kernel_8
    ble         epilog

start_kernel_8_element:
    subs        x7,x7,#4
    add         x0,x0,#8
...
kernel_8_element:
    ...
    sqshrn      v30.4h, v30.4s,#6
    smull       v19.4s, v1.4h, v23.4h               //mul_res1 = vmull_u8(src_tmp2, coeffabs_1)//
    ld1         {v16.8h},[x3],x2                    //src_tmp1 = vld1_u8(pu1_src_tmp)//
    subs        x4,x4,#8
    smlal       v19.4s, v0.4h, v22.4h               //mul_res1 = vmlal_u8(mul_res1, src_tmp1, coeffabs_0)//
    add         x10,x0,x8,lsl #0
    smlal       v19.4s, v2.4h, v24.4h               //mul_res1 = vmlal_u8(mul_res1, src_tmp3, coeffabs_2)//
    ...
    ld1         {v17.8h},[x3],x2                    //src_tmp2 = vld1_u8(pu1_src_tmp)//
    smull       v20.4s, v2.4h, v23.4h               //mul_res2 = vmull_u8(src_tmp3, coeffabs_1)//
    smlal       v20.4s, v1.4h, v22.4h               //mul_res2 = vmlal_u8(mul_res2, src_tmp2, coeffabs_0)//
    smlal       v20.4s, v3.4h, v24.4h               //mul_res2 = vmlal_u8(mul_res2, src_tmp4, coeffabs_2)//
    smlal       v20.4s, v4.4h, v25.4h               //mul_res2 = vmlal_u8(mul_res2, src_tmp1, coeffabs_3)//
    ...
    ld1         {v18.8h},[x3],x2                    //src_tmp3 = vld1_u8(pu1_src_tmp)//
    smull       v21.4s, v3.4h, v23.4h
    smlal       v21.4s, v2.4h, v22.4h
    smlal       v21.4s, v4.4h, v24.4h
    st1         {v30.s}[0],[x14],x6
    ...
    smlal       v30.4s, v6.4h, v25.4h
    smlal       v30.4s, v7.4h, v26.4h
    st1         {v19.s}[0],[x1]                     //vst1_u8(pu1_dst,sto_res)//
    smlal       v30.4s, v16.4h, v27.4h
    smlal       v30.4s, v17.4h, v28.4h
    add         x1,x1,#8
    smlal       v30.4s, v18.4h, v29.4h
    ...
    smull2       v19.4s, v1.8h, v23.8h              //mul_res1 = vmull_u8(src_tmp2, coeffabs_1)//
    smlal2       v19.4s, v0.8h, v22.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp1, coeffabs_0)//
    smlal2       v19.4s, v2.8h, v24.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp3, coeffabs_2)//
    ld1         {v0.8h},[x0],#16                    //src_tmp1 = vld1_u8(pu1_src_tmp)//
    smlal2       v19.4s, v3.8h, v25.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp4, coeffabs_3)//
    smlal2       v19.4s, v4.8h, v26.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp1, coeffabs_4)//
    st1         {v20.s}[0],[x14],x6                 //vst1_u8(pu1_dst_tmp,sto_res)//
    smlal2       v19.4s, v5.8h, v27.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp2, coeffabs_5)//
    smlal2       v19.4s, v6.8h, v28.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp3, coeffabs_6)//
    smlal2       v19.4s, v7.8h, v29.8h              //mul_res1 = vmlal_u8(mul_res1, src_tmp4, coeffabs_7)//

    sqshrn      v30.4h, v30.4s,#6
    sqrshrun    v21.8b, v21.8h,#6

    smull2       v20.4s, v2.8h, v23.8h              //mul_res2 = vmull_u8(src_tmp3, coeffabs_1)//
    smlal2       v20.4s, v1.8h, v22.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp2, coeffabs_0)//
    smlal2       v20.4s, v3.8h, v24.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp4, coeffabs_2)//
    ld1         {v1.8h},[x3],x2                     //src_tmp2 = vld1_u8(pu1_src_tmp)//
    smlal2       v20.4s, v4.8h, v25.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp1, coeffabs_3)//
    smlal2       v20.4s, v5.8h, v26.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp2, coeffabs_4)//
    smlal2       v20.4s, v6.8h, v27.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp3, coeffabs_5)//
    st1         {v21.s}[0],[x14],x6
    smlal2       v20.4s, v7.8h, v28.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp4, coeffabs_6)//
    smlal2       v20.4s,v16.8h, v29.8h              //mul_res2 = vmlal_u8(mul_res2, src_tmp1, coeffabs_7)//

    sqshrn      v19.4h, v19.4s,#6
    sqrshrun    v30.8b, v30.8h,#6

    smull2       v21.4s, v3.8h, v23.8h
    st1         {v30.s}[0],[x14],x6
    smlal2       v21.4s, v2.8h, v22.8h
    add         x14,x13,#0
    ld1         {v2.8h},[x3],x2                     //src_tmp3 = vld1_u8(pu1_src_tmp)//
    smlal2       v21.4s, v4.8h, v24.8h
    smlal2       v21.4s, v5.8h, v25.8h
    smlal2       v21.4s, v6.8h, v26.8h
    smlal2       v21.4s, v7.8h, v27.8h
    smlal2       v21.4s,v16.8h, v28.8h
    smlal2       v21.4s,v17.8h, v29.8h

    sqshrn      v20.4h, v20.4s,#6
    sqrshrun    v19.8b, v19.8h,#6                   //sto_res = vqmovun_s16(sto_res_tmp)//

    smull2       v30.4s, v4.8h, v23.8h
    smlal2       v30.4s, v3.8h, v22.8h
    smlal2       v30.4s, v5.8h, v24.8h
    ld1         {v3.8h},[x3],x2                     //src_tmp4 = vld1_u8(pu1_src_tmp)//
    smlal2       v30.4s, v6.8h, v25.8h
    ld1         {v4.8h},[x3],x2                     //src_tmp1 = vld1_u8(pu1_src_tmp)//
    smlal2       v30.4s, v7.8h, v26.8h
    ld1         {v5.8h},[x3],x2                     //src_tmp2 = vld1_u8(pu1_src_tmp)//
    smlal2       v30.4s,v16.8h, v27.8h
    st1         {v19.s}[0],[x14],x6                 //vst1_u8(pu1_dst,sto_res)//
    smlal2       v30.4s,v17.8h, v28.8h
    ld1         {v6.8h},[x3],x2                     //src_tmp3 = vld1_u8(pu1_src_tmp)//
    subs        x7,x7,#8
    ld1         {v7.8h},[x3],x2                     //src_tmp4 = vld1_u8(pu1_src_tmp)//
    smlal2       v30.4s,v18.8h, v29.8h

    sqshrn      v21.4h, v21.4s,#6
    sqrshrun    v20.8b, v20.8h,#6                   //sto_res = vqmovun_s16(sto_res_tmp)//

    bgt         kernel_8_element                    //jumps to kernel_8
    ble         epilog_end
