...
.globl ihevc_hbd_itrans_recon_4x4_ttype1_av8

.type ihevc_hbd_itrans_recon_4x4_ttype1_av8, %function

ihevc_hbd_itrans_recon_4x4_ttype1_av8:
    ...
    //loading pred
    add         x5, x5, x5      //stride = stride * 2
    ld1         {v4.4h},[x2],x5
    ld1         {v5.4h},[x2],x5
    ld1         {v6.4h},[x2],x5
    ld1         {v7.4h},[x2],x5

    //add pred to inv trans s16 output
    add         v0.4h, v0.4h, v4.4h
    add         v1.4h, v1.4h, v5.4h
    add         v2.4h, v2.4h, v6.4h
    add         v3.4h, v3.4h, v7.4h

    //Applying clip3(0, clip_limit)
    mov w1, #clip_limit
    dup v5.4h, w1
    smin v0.4h, v0.4h, v5.4h
    smin v1.4h, v1.4h, v5.4h
    smin v2.4h, v2.4h, v5.4h
    smin v3.4h, v3.4h, v5.4h
