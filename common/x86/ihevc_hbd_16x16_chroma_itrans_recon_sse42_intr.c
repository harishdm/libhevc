...
void ihevc_hbd_chroma_itrans_recon_16x16_sse42(WORD16 *pi2_src,
                                     WORD16 *pi2_tmp,
                                     UWORD16 *pu2_pred,
                                     UWORD16 *pu2_dst,
                                     WORD32 src_strd,
                                     ...
                                     UWORD8 bit_depth)
{
    ...
    __m128i m_count, m_min, m_max, chroma_shuffle_mask_16x8b, blend_mask;
    ...
    /* Transpose */
    {
        ...
        for(i = 0; i < 2; i++)
        {
            ...
            for(j = 0; j < 2; j++)
            {
                ...
                m_temp_reg_70 = _mm_loadu_si128((__m128i *)pu2_pred_temp);
                m_temp_reg_71 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 8));
                m_temp_reg_72 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 16));
                m_temp_reg_73 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 24));

                m_temp_reg_70  = _mm_shuffle_epi8 (m_temp_reg_70, chroma_shuffle_mask_16x8b);
                m_temp_reg_71  = _mm_shuffle_epi8 (m_temp_reg_71, chroma_shuffle_mask_16x8b);
                m_temp_reg_72  = _mm_shuffle_epi8 (m_temp_reg_72, chroma_shuffle_mask_16x8b);
                m_temp_reg_73  = _mm_shuffle_epi8 (m_temp_reg_73, chroma_shuffle_mask_16x8b);

                m_temp_reg_0 = _mm_unpacklo_epi64(m_temp_reg_70, m_temp_reg_71);
                m_temp_reg_12 = _mm_unpacklo_epi64(m_temp_reg_72, m_temp_reg_73);
                ...
                m_temp_reg_70 = _mm_unpacklo_epi16(m_temp_reg_40, m_min);
                m_temp_reg_71 = _mm_unpackhi_epi16(m_temp_reg_40, m_min);
                m_temp_reg_72 = _mm_unpacklo_epi16(m_temp_reg_44, m_min);
                m_temp_reg_73 = _mm_unpackhi_epi16(m_temp_reg_44, m_min);

                m_temp_reg_74 = _mm_loadu_si128((__m128i *)(pu2_dst));
                m_temp_reg_75 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_76 = _mm_loadu_si128((__m128i *)(pu2_dst + 16));
                m_temp_reg_77 = _mm_loadu_si128((__m128i *)(pu2_dst + 24));

                m_temp_reg_70 = _mm_blendv_epi8(m_temp_reg_70,m_temp_reg_74,blend_mask);
                m_temp_reg_71 = _mm_blendv_epi8(m_temp_reg_71,m_temp_reg_75,blend_mask);
                m_temp_reg_72 = _mm_blendv_epi8(m_temp_reg_72,m_temp_reg_76,blend_mask);
                m_temp_reg_73 = _mm_blendv_epi8(m_temp_reg_73,m_temp_reg_77,blend_mask);

                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_70);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_71);
                _mm_storeu_si128((__m128i *) (pu2_dst + 16), m_temp_reg_72);
                _mm_storeu_si128((__m128i *) (pu2_dst + 24), m_temp_reg_73);

                pu2_dst += out_stride;
                pu2_pred_temp += pred_strd;

                m_temp_reg_40 = _mm_unpackhi_epi64(m_temp_reg_30, m_temp_reg_32);//omkigeca1
                m_temp_reg_70 = _mm_loadu_si128((__m128i *)pu2_pred_temp);
                m_temp_reg_71 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 8));
                m_temp_reg_72 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 16));
                m_temp_reg_73 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 24));
                ...
                m_temp_reg_44 = _mm_unpackhi_epi64(m_temp_reg_36, m_temp_reg_34);//bdfhjlnp0
                m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_40, m_temp_reg_0);
                m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_44, m_temp_reg_12);
                ...
                m_temp_reg_40 = _mm_unpacklo_epi64(m_temp_reg_31, m_temp_reg_33);//omkigeca2
                m_temp_reg_70 = _mm_loadu_si128((__m128i *)pu2_pred_temp);
                m_temp_reg_71 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 8));
                m_temp_reg_72 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 16));
                m_temp_reg_73 = _mm_loadu_si128((__m128i *)(pu2_pred_temp + 24));
                ...
                m_temp_reg_44 = _mm_unpacklo_epi64(m_temp_reg_37, m_temp_reg_35);//bdfhjlnp0
                m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_40, m_temp_reg_0);
                m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_44, m_temp_reg_12);
                ...
                m_temp_reg_40 = _mm_unpackhi_epi64(m_temp_reg_31, m_temp_reg_33);//omkigeca3
                ...
                m_temp_reg_44 = _mm_unpackhi_epi64(m_temp_reg_37, m_temp_reg_35);//bdfhjlnp0
                m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_40, m_temp_reg_0);
                m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_44, m_temp_reg_12);
