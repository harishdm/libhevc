 ...
 */
/**/
void ihevc_hbd_itrans_recon_32x32_sse42(WORD16 *pi2_src,
                              WORD16 *pi2_tmp,
                              UWORD16 *pu2_pred,
                              UWORD16 *pu2_dst,
                              WORD32 src_strd,
                              ...
                              UWORD8 bit_depth)
{
    ...
    m_max =  _mm_cmpeq_epi16(all_zero_reg, all_zero_reg);
    ...
    for(j = 0; j < trans_size; j +=4)
    {
        ...
        /* Transpose */
        {
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_30, m_temp_reg_0);

            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 8));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_34, m_temp_reg_0);
            ...
            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 16));

            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_36, m_temp_reg_0);

            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 24));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_32, m_temp_reg_0);
            ...
            _mm_storeu_si128((__m128i *)(pu2_dst + 16), m_temp_reg_40);
            _mm_storeu_si128((__m128i *)(pu2_dst + 24), m_temp_reg_44);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_31, m_temp_reg_0);
            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 8));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_35, m_temp_reg_0);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_37, m_temp_reg_0);

            m_temp_reg_0 =_mm_loadu_si128((__m128i *)(pu2_pred + 24));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_33, m_temp_reg_0);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_80, m_temp_reg_0);
            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 8));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_84, m_temp_reg_0);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_86, m_temp_reg_0);

            m_temp_reg_0 =_mm_loadu_si128((__m128i *)(pu2_pred + 24));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_82, m_temp_reg_0);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_81, m_temp_reg_0);
            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 8));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_85, m_temp_reg_0);
            ...
            m_temp_reg_40 = _mm_adds_epi16(m_temp_reg_87, m_temp_reg_0);

            m_temp_reg_0 = _mm_loadu_si128((__m128i *)(pu2_pred + 24));

            m_temp_reg_44 = _mm_adds_epi16(m_temp_reg_83, m_temp_reg_0);
