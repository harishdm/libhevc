...
*******************************************************************************
* @file
*  ihevc_quant_iquant_ssd_x86_intr.c
*
* @brief
...
*******************************************************************************
*/
WORD32 ihevc_quant_iquant_ssd_flat_scale_mat_sse42
(
WORD16 *pi2_coeffs,
...
)
{
    ...
    __m128i m_scale_iq = _mm_set1_epi32((g_ihevc_iquant_scales_flat_scale[qp_rem]));
    ...
    __m128i m_sign0, m_sign1;
    //__m128i m_sign2, m_sign3;
    __m128i m_add_q;
    ...
    if (0 == (trans_size & 31))
    {
        for (i = 0; i < trans_size; i += 4)
        {
            for (j = 0; j < trans_size; j += 16)
            {
                ...
                /* tmp = tmp * sign;  */
                /**********************/
                /*row=0*/   m_src_temp4 = _mm_sign_epi32(m_src_temp4, m_src_temp0);         /* col= [0][1][2][3]*/
                /*row=1*/   m_src_temp5 = _mm_sign_epi32(m_src_temp5, m_src_temp1);         /* col= [0][1][2][3]*/
                /*row=2*/   m_src_temp6 = _mm_sign_epi32(m_src_temp6, m_src_temp2);         /* col= [0][1][2][3]*/
                /*row=3*/   m_src_temp7 = _mm_sign_epi32(m_src_temp7, m_src_temp3);         /* col= [0][1][2][3]*/
                ...
                *(csbf + block_col) = 0;
                ...
                m_src_temp4 = _mm_mullo_epi32(m_src_temp4, m_scale_iq);
                m_src_temp5 = _mm_mullo_epi32(m_src_temp5, m_scale_iq);
                m_src_temp6 = _mm_mullo_epi32(m_src_temp6, m_scale_iq);
                m_src_temp7 = _mm_mullo_epi32(m_src_temp7, m_scale_iq);
                ...
                m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 4 + ((0)*src_strd)));       /* inp row =0*/
                m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 4 + ((1)*src_strd)));       /* inp row =1*/
                m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 4 + ((2)*src_strd)));       /* inp row =2*/
                m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 4 + ((3)*src_strd)));       /* inp row= 3 */
                ...
                *(csbf + block_col) = 0;
                ...
                /********************* Inverse Quantization  *********************/
                //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+4+((0)*trans_size)));     /* deq row =0*/
                //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
                //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+4+((1)*trans_size)));     /* deq row =1*/
                //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
                //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+4+((2)*trans_size)));     /* deq row =2*/
                //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
                //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+4+((3)*trans_size)));     /* deq row= 3*/
                //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
                /********************* Inverse Quantization  *********************/

                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 4 + ((0)*dst_q_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 4 + ((1)*dst_q_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 4 + ((2)*dst_q_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 4 + ((3)*dst_q_strd)), m_src_temp11);
                ...
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 4 + ((0)*dst_iq_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 4 + ((1)*dst_iq_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 4 + ((2)*dst_iq_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 4 + ((3)*dst_iq_strd)), m_src_temp11);
                /********************* Inverse Quantization  *********************/
                ...
                m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 8 + ((0)*src_strd)));       /* inp row =0*/
                m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 8 + ((1)*src_strd)));       /* inp row =1*/
                m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 8 + ((2)*src_strd)));       /* inp row =2*/
                m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 8 + ((3)*src_strd)));       /* inp row= 3 */
                ...
                *(csbf + block_col) = 0;
                ...
                /********************* Inverse Quantization  *********************/
                //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+8+((0)*trans_size)));     /* deq row =0*/
                //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
                //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+8+((1)*trans_size)));     /* deq row =1*/
                //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
                //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+8+((2)*trans_size)));     /* deq row =2*/
                //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
                //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+8+((3)*trans_size)));     /* deq row= 3*/
                //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
                /********************* Inverse Quantization  *********************/

                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 8 + ((0)*dst_q_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 8 + ((1)*dst_q_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 8 + ((2)*dst_q_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 8 + ((3)*dst_q_strd)), m_src_temp11);
                ...
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 8 + ((0)*dst_iq_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 8 + ((1)*dst_iq_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 8 + ((2)*dst_iq_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 8 + ((3)*dst_iq_strd)), m_src_temp11);
                /********************* Inverse Quantization  *********************/
                ...
                m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 12 + ((0)*src_strd)));      /* inp row =0*/
                m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 12 + ((1)*src_strd)));      /* inp row =1*/
                m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 12 + ((2)*src_strd)));      /* inp row =2*/
                m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + j + 12 + ((3)*src_strd)));      /* inp row= 3 */
                ...
                *(csbf + block_col) = 0;
                ...
                /********************* Inverse Quantization  *********************/
                //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+12+((0)*trans_size)));        /* deq row =0*/
                //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
                //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+12+((1)*trans_size)));        /* deq row =1*/
                //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
                //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+12+((2)*trans_size)));        /* deq row =2*/
                //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
                //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+j+12+((3)*trans_size)));        /* deq row= 3*/
                //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
                /********************* Inverse Quantization  *********************/

                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 12 + ((0)*dst_q_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 12 + ((1)*dst_q_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 12 + ((2)*dst_q_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_q_dst + j + 12 + ((3)*dst_q_strd)), m_src_temp11);
                ...
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 12 + ((0)*dst_iq_strd)), m_src_temp8);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 12 + ((1)*dst_iq_strd)), m_src_temp10);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 12 + ((2)*dst_iq_strd)), m_src_temp9);
                _mm_storel_epi64((__m128i *)(pi2_iq_dst + j + 12 + ((3)*dst_iq_strd)), m_src_temp11);
                /********************* Inverse Quantization  *********************/
    ...
    else if (0 == (trans_size & 15))
    {
        for (i = 0; i < trans_size; i += 4)
        {

            m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + ((0)*src_strd)));       /* inp row =0*/
            m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + ((1)*src_strd)));       /* inp row =1*/
            m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + ((2)*src_strd)));       /* inp row =2*/
            m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + ((3)*src_strd)));       /* inp row= 3 */
            ...
            *(csbf + block_col) = 0;
            ...
            /********************* Inverse Quantization  *********************/
            //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+((0)*trans_size)));     /* deq row =0*/
            //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
            //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+((1)*trans_size)));     /* deq row =1*/
            //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
            //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+((2)*trans_size)));     /* deq row =2*/
            //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
            //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+((3)*trans_size)));     /* deq row= 3*/
            //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
            /********************* Inverse Quantization  *********************/

            _mm_storel_epi64((__m128i *)(pi2_q_dst + ((0)*dst_q_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + ((1)*dst_q_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + ((2)*dst_q_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + ((3)*dst_q_strd)), m_src_temp11);
            ...
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + ((0)*dst_iq_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + ((1)*dst_iq_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + ((2)*dst_iq_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + ((3)*dst_iq_strd)), m_src_temp11);
            /********************* Inverse Quantization  *********************/
            ...
            m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 4 + ((0)*src_strd)));       /* inp row =0*/
            m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 4 + ((1)*src_strd)));       /* inp row =1*/
            m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 4 + ((2)*src_strd)));       /* inp row =2*/
            m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 4 + ((3)*src_strd)));       /* inp row= 3 */
            ...
            *(csbf + block_col) = 0;
            ...
            /********************* Inverse Quantization  *********************/
            //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+4+((0)*trans_size)));       /* deq row =0*/
            //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
            //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+4+((1)*trans_size)));       /* deq row =1*/
            //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
            //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+4+((2)*trans_size)));       /* deq row =2*/
            //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
            //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+4+((3)*trans_size)));       /* deq row= 3*/
            //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
            /********************* Inverse Quantization  *********************/

            _mm_storel_epi64((__m128i *)(pi2_q_dst + 4 + ((0)*dst_q_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 4 + ((1)*dst_q_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 4 + ((2)*dst_q_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 4 + ((3)*dst_q_strd)), m_src_temp11);
            ...
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 4 + ((0)*dst_iq_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 4 + ((1)*dst_iq_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 4 + ((2)*dst_iq_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 4 + ((3)*dst_iq_strd)), m_src_temp11);
            /********************* Inverse Quantization  *********************/
            ...
            m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 8 + ((0)*src_strd)));       /* inp row =0*/
            m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 8 + ((1)*src_strd)));       /* inp row =1*/
            m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 8 + ((2)*src_strd)));       /* inp row =2*/
            m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 8 + ((3)*src_strd)));       /* inp row= 3 */
            ...
            *(csbf + block_col) = 0;
            ...
            /********************* Inverse Quantization  *********************/
            //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+8+((0)*trans_size)));       /* deq row =0*/
            //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
            //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+8+((1)*trans_size)));       /* deq row =1*/
            //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
            //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+8+((2)*trans_size)));       /* deq row =2*/
            //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
            //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+8+((3)*trans_size)));       /* deq row= 3*/
            //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
            /********************* Inverse Quantization  *********************/

            _mm_storel_epi64((__m128i *)(pi2_q_dst + 8 + ((0)*dst_q_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 8 + ((1)*dst_q_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 8 + ((2)*dst_q_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 8 + ((3)*dst_q_strd)), m_src_temp11);
            ...
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 8 + ((0)*dst_iq_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 8 + ((1)*dst_iq_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 8 + ((2)*dst_iq_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 8 + ((3)*dst_iq_strd)), m_src_temp11);
            /********************* Inverse Quantization  *********************/
            ...
            m_src_temp0 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 12 + ((0)*src_strd)));      /* inp row =0*/
            m_src_temp1 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 12 + ((1)*src_strd)));      /* inp row =1*/
            m_src_temp2 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 12 + ((2)*src_strd)));      /* inp row =2*/
            m_src_temp3 = _mm_loadl_epi64((__m128i *) (pi2_coeffs + 12 + ((3)*src_strd)));      /* inp row= 3 */
            ...
            *(csbf + block_col) = 0;
            ...
            /********************* Inverse Quantization  *********************/
            //m_src_temp12 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+12+((0)*trans_size)));      /* deq row =0*/
            //m_src_temp12 = _mm_mullo_epi16(m_src_temp12, m_scale_iq);
            //m_src_temp13 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+12+((1)*trans_size)));      /* deq row =1*/
            //m_src_temp13 = _mm_mullo_epi16(m_src_temp13, m_scale_iq);
            //m_src_temp14 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+12+((2)*trans_size)));      /* deq row =2*/
            //m_src_temp14 = _mm_mullo_epi16(m_src_temp14, m_scale_iq);
            //m_src_temp15 = _mm_loadl_epi64((__m128i *) (pi2_dequant_coeff+12+((3)*trans_size)));      /* deq row= 3*/
            //m_src_temp15 = _mm_mullo_epi16(m_src_temp15, m_scale_iq);
            /********************* Inverse Quantization  *********************/

            _mm_storel_epi64((__m128i *)(pi2_q_dst + 12 + ((0)*dst_q_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 12 + ((1)*dst_q_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 12 + ((2)*dst_q_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_q_dst + 12 + ((3)*dst_q_strd)), m_src_temp11);
            ...
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 12 + ((0)*dst_iq_strd)), m_src_temp8);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 12 + ((1)*dst_iq_strd)), m_src_temp10);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 12 + ((2)*dst_iq_strd)), m_src_temp9);
            _mm_storel_epi64((__m128i *)(pi2_iq_dst + 12 + ((3)*dst_iq_strd)), m_src_temp11);
            /********************* Inverse Quantization  *********************/
...
/*venkat:*/
WORD32 ihevc_quant_iquant_ssd_flat_scale_mat_smoothing_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
...
)
{
    ...
    {
        WORD32 i4_loop_rep;
        i4_loop_rep = trans_size;

#if SMOOTHENING_Q_IQ_32x32
        i4_loop_rep = 16;
#endif
        for (i = 0; i < trans_size; i += 4)
        {
...
WORD32 ihevc_quant_iquant_flat_scale_mat_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
...
WORD32 ihevc_quant_iquant_ssd_flat_scale_mat_rdoq_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
...
WORD32 ihevc_quant_iquant_flat_scale_mat_rdoq_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
...
WORD32 ihevc_q_iq_ssd_flat_scale_mat_var_rnd_fact_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
...
)
{
    ...
    WORD32 bit_depth, shift_iq, transform_shift;
    ...
    iquant_coeff = _mm_set1_epi32(g_ihevc_iquant_scales_flat_scale[qp_rem]);
...
WORD32 ihevc_q_iq_flat_scale_mat_var_rnd_fact_sse42
(
WORD16 *pi2_coeffs,
WORD16 *pi2_quant_coeff,
WORD16 *pi2_q_dst,
