 ...
 *******************************************************************************
 * @file
 *  ihevc_hbd_chroma_itrans_recon_x86_intr.c
 *
 * @brief
 ...
 *******************************************************************************
 */
void ihevc_hbd_chroma_itrans_recon_4x4_sse42(WORD16 *pi2_src,
                                   WORD16 *pi2_tmp,
                                   UWORD16 *pu2_pred,
                                   UWORD16 *pu2_dst,
                                   WORD32 src_strd,
                                   ...
                                   UWORD8 bit_depth)
{
    ...
    __m128i m_coeff1, m_coeff3, m_coeff0, m_coeff2;
    __m128i m_rdng_factor;
    __m128i m_count, m_max, m_min, chroma_shuffle_mask_16x8b,blend_mask;
    ...
    m_coeff0 = _mm_loadu_si128((__m128i *) &g_ai2_ihevc_trans_intr_4[0][0]);
    m_coeff1 = _mm_loadu_si128((__m128i *) &g_ai2_ihevc_trans_intr_4[1][0]);
    m_coeff2 = _mm_loadu_si128((__m128i *) &g_ai2_ihevc_trans_intr_4[2][0]);
    m_coeff3 = _mm_loadu_si128((__m128i *) &g_ai2_ihevc_trans_intr_4[3][0]);

    m_temp_reg_13 = _mm_unpacklo_epi16(m_temp_reg_1,m_temp_reg_3);
    m_temp_reg_02 = _mm_unpacklo_epi16(m_temp_reg_0,m_temp_reg_2);

    m_temp_reg_20 = _mm_madd_epi16(m_temp_reg_13,m_coeff0); //o0
    m_temp_reg_21 = _mm_madd_epi16(m_temp_reg_13,m_coeff1); //o1
    m_temp_reg_22 = _mm_madd_epi16(m_temp_reg_02,m_coeff2); //e0
    m_temp_reg_23 = _mm_madd_epi16(m_temp_reg_02,m_coeff3); //e1

    m_temp_reg_30 = _mm_add_epi32(m_temp_reg_22,m_temp_reg_20);
    m_temp_reg_31 = _mm_add_epi32(m_temp_reg_23,m_temp_reg_21);

    m_temp_reg_32 = _mm_sub_epi32(m_temp_reg_23,m_temp_reg_21);
    m_temp_reg_33 = _mm_sub_epi32(m_temp_reg_22,m_temp_reg_20);
    ...
    m_temp_reg_32 = _mm_add_epi32(m_temp_reg_32,m_rdng_factor);
    m_temp_reg_33 = _mm_add_epi32(m_temp_reg_33,m_rdng_factor);

    m_count = _mm_cvtsi32_si128(i4_shift);
    {
        m_temp_reg_20 = _mm_sra_epi32(m_temp_reg_30, m_count);
        m_temp_reg_21 = _mm_sra_epi32(m_temp_reg_31, m_count);
        m_temp_reg_22 = _mm_sra_epi32(m_temp_reg_32, m_count);
        m_temp_reg_23 = _mm_sra_epi32(m_temp_reg_33, m_count);
    ...
    /* Stage 2 */
    {
        i4_shift = 20 - bit_depth;

        m_temp_reg_22 = _mm_srli_si128(m_temp_reg_20, 8);
        m_temp_reg_23 = _mm_srli_si128(m_temp_reg_21, 8);

        m_temp_reg_13 = _mm_unpacklo_epi16(m_temp_reg_22,m_temp_reg_23);
        m_temp_reg_02 = _mm_unpacklo_epi16(m_temp_reg_20,m_temp_reg_21);
        ...
        /* Recon and store */
        {
            UWORD16  *temp = pu2_dst;
            chroma_shuffle_mask_16x8b = _mm_loadl_epi64((__m128i *) &IHEVCE_CHROMA_SHUFFLEMASK_HBD[0]);

            m_temp_reg_0 = _mm_loadu_si128((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_1 = _mm_loadu_si128((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_2 = _mm_loadu_si128((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_3 = _mm_loadu_si128((__m128i *) pu2_pred);
            ...
            m_temp_reg_20 = _mm_adds_epi16(m_temp_reg_20, m_temp_reg_0);
            m_temp_reg_21 = _mm_adds_epi16(m_temp_reg_21, m_temp_reg_1);

            m_max =  _mm_cmpeq_epi16(m_temp_reg_0, m_temp_reg_0);
            m_count = _mm_cvtsi32_si128((16 - bit_depth));
            m_max = _mm_srl_epi16(m_max, m_count);

            blend_mask = _mm_cmpeq_epi16(m_temp_reg_0, m_temp_reg_0);
            m_count = _mm_cvtsi32_si128(16);
            blend_mask = _mm_sll_epi32(blend_mask, m_count);

            m_min = _mm_setzero_si128();

            m_temp_reg_20 = _mm_max_epi16(m_temp_reg_20, m_min);
            m_temp_reg_21 = _mm_max_epi16(m_temp_reg_21, m_min);

            m_temp_reg_20 = _mm_min_epi16(m_temp_reg_20, m_max);
            m_temp_reg_21 = _mm_min_epi16(m_temp_reg_21, m_max);

            m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_20, m_min);
            m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_20, m_min);
            m_temp_reg_2 = _mm_unpacklo_epi16(m_temp_reg_21, m_min);
            m_temp_reg_3 = _mm_unpackhi_epi16(m_temp_reg_21, m_min);

            m_temp_reg_30 = _mm_loadu_si128((__m128i *) temp);
            temp += dst_strd;
            m_temp_reg_31 = _mm_loadu_si128((__m128i *) temp);
            temp += dst_strd;
            m_temp_reg_32 = _mm_loadu_si128((__m128i *) temp);
            temp += dst_strd;
            m_temp_reg_33 = _mm_loadu_si128((__m128i *) temp);

            m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_30,blend_mask);
            m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_31,blend_mask);
            m_temp_reg_22 = _mm_blendv_epi8(m_temp_reg_2,m_temp_reg_32,blend_mask);
            m_temp_reg_23 = _mm_blendv_epi8(m_temp_reg_3,m_temp_reg_33,blend_mask);

            _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_20);
            pu2_dst += dst_strd;
            _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_21);
            pu2_dst += dst_strd;
            _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_22);
            pu2_dst += dst_strd;
            _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_23);
            pu2_dst += dst_strd;
        }
    }
}

void ihevc_hbd_chroma_itrans_recon_8x8_sse42(WORD16 *pi2_src,
                            WORD16 *pi2_tmp,
                            UWORD16 *pu2_pred,
                            UWORD16 *pu2_dst,
                            WORD32 src_strd,
                            ...
                            UWORD8 bit_depth)
{
    ...
    __m128i m_count, m_max, m_min, blend_mask, chroma_shuffle_mask_16x8b;
    ...
    m_max =  _mm_cmpeq_epi16(m_temp_reg_70, m_temp_reg_70);
    m_count = _mm_cvtsi32_si128((16 - bit_depth));
    m_max = _mm_srl_epi16(m_max, m_count);
    m_min = _mm_setzero_si128();
    ...
    if (!check_row_stage_2)
    {
        ...
        i4_shift = 20 - bit_depth;
        {
            ...
            /* Recon and store */
            {
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_pred);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_pred + 8));
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_0 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_1 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_2 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_3 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_4 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_5 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);
                pu2_pred += pred_strd;
                ...
                m_temp_reg_20 = _mm_shuffle_epi8 (m_temp_reg_20, chroma_shuffle_mask_16x8b);
                m_temp_reg_21 = _mm_shuffle_epi8 (m_temp_reg_21, chroma_shuffle_mask_16x8b);
                m_temp_reg_7 = _mm_unpacklo_epi64(m_temp_reg_20, m_temp_reg_21);

                m_temp_reg_50 = _mm_adds_epi16(m_temp_reg_10, m_temp_reg_0);
                m_temp_reg_51 = _mm_adds_epi16(m_temp_reg_11, m_temp_reg_1);
                m_temp_reg_52 = _mm_adds_epi16(m_temp_reg_12, m_temp_reg_2);
                m_temp_reg_53 = _mm_adds_epi16(m_temp_reg_13, m_temp_reg_3);
                m_temp_reg_54 = _mm_adds_epi16(m_temp_reg_14, m_temp_reg_4);
                m_temp_reg_55 = _mm_adds_epi16(m_temp_reg_15, m_temp_reg_5);
                m_temp_reg_56 = _mm_adds_epi16(m_temp_reg_16, m_temp_reg_6);
                m_temp_reg_57 = _mm_adds_epi16(m_temp_reg_17, m_temp_reg_7);

                m_temp_reg_50 = _mm_max_epi16(m_temp_reg_50, m_min);
                m_temp_reg_51 = _mm_max_epi16(m_temp_reg_51, m_min);
                m_temp_reg_52 = _mm_max_epi16(m_temp_reg_52, m_min);
                m_temp_reg_53 = _mm_max_epi16(m_temp_reg_53, m_min);
                m_temp_reg_54 = _mm_max_epi16(m_temp_reg_54, m_min);
                m_temp_reg_55 = _mm_max_epi16(m_temp_reg_55, m_min);
                m_temp_reg_56 = _mm_max_epi16(m_temp_reg_56, m_min);
                m_temp_reg_57 = _mm_max_epi16(m_temp_reg_57, m_min);

                m_temp_reg_50 = _mm_min_epi16(m_temp_reg_50, m_max);
                m_temp_reg_51 = _mm_min_epi16(m_temp_reg_51, m_max);
                m_temp_reg_52 = _mm_min_epi16(m_temp_reg_52, m_max);
                m_temp_reg_53 = _mm_min_epi16(m_temp_reg_53, m_max);
                m_temp_reg_54 = _mm_min_epi16(m_temp_reg_54, m_max);
                m_temp_reg_55 = _mm_min_epi16(m_temp_reg_55, m_max);
                m_temp_reg_56 = _mm_min_epi16(m_temp_reg_56, m_max);
                m_temp_reg_57 = _mm_min_epi16(m_temp_reg_57, m_max);

                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_50, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_50, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                pu2_dst += dst_strd;

                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_51, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_51, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_52, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_52, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_53, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_53, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_54, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_54, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_55, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_55, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_56, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_56, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
                ...
                m_temp_reg_20 = _mm_loadu_si128((__m128i *)pu2_dst);
                m_temp_reg_21 = _mm_loadu_si128((__m128i *)(pu2_dst + 8));
                m_temp_reg_0 = _mm_unpacklo_epi16(m_temp_reg_57, m_min);
                m_temp_reg_1 = _mm_unpackhi_epi16(m_temp_reg_57, m_min);
                m_temp_reg_20 = _mm_blendv_epi8(m_temp_reg_0,m_temp_reg_20,blend_mask);
                m_temp_reg_21 = _mm_blendv_epi8(m_temp_reg_1,m_temp_reg_21,blend_mask);
                _mm_storeu_si128((__m128i *) (pu2_dst), m_temp_reg_20);
                _mm_storeu_si128((__m128i *) (pu2_dst + 8), m_temp_reg_21);
