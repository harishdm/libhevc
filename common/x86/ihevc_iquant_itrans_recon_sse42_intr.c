...
void ihevc_iquant_itrans_recon_4x4_ttype1_sse42(WORD16 *pi2_src,
                                          WORD16 *pi2_tmp,
                                          UWORD8 *pu1_pred,
...
void ihevc_iquant_itrans_recon_4x4_sse42(WORD16 *pi2_src,
                                          WORD16 *pi2_tmp,
                                          UWORD8 *pu1_pred,
                                          WORD16 *pi2_dequant_coeff,
                                          UWORD8 *pu1_dst,
 ...
 *******************************************************************************
 */
void ihevc_iquant_itrans_recon_8x8_sse42(WORD16 *pi2_src,
                                   WORD16 *pi2_tmp,
                                   UWORD8 *pu1_pred,
                                   WORD16 *pi2_dequant_coeff,
                                   UWORD8 *pu1_dst,
...
*/
    ...
    /* Stage 2 */
    {
        ...
        /* Recon and store */
        {
            ...
            m_temp_reg_2 = _mm_cvtepu8_epi16(m_temp_reg_2);
            m_temp_reg_3 = _mm_cvtepu8_epi16(m_temp_reg_3);
            m_temp_reg_4 = _mm_cvtepu8_epi16(m_temp_reg_4);
            m_temp_reg_5 = _mm_cvtepu8_epi16(m_temp_reg_5);
            m_temp_reg_6 = _mm_cvtepu8_epi16(m_temp_reg_6);
            m_temp_reg_7 = _mm_cvtepu8_epi16(m_temp_reg_7);
...
/*
                ...
                m_temp_reg_17 = m_temp_reg_65;
                m_temp_reg_15 = m_temp_reg_61;
*/
