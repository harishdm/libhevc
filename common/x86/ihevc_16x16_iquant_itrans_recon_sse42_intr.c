 ...
 *******************************************************************************
 */
void ihevc_iquant_itrans_recon_16x16_sse42(WORD16 *pi2_src,
                                     WORD16 *pi2_tmp,
                                     UWORD8 *pu1_pred,
...

{
    ...
    for(i = 0; i < 2; i++)
    {
        ...
        if(zero_last12_rows_stg2)
        {
            ...
            {
                WORD32 j;
                UWORD8 *pu1_src_scratch = pu1_dst;
    ...
    /* Transpose */
    {
        ...
        for(i = 0; i < 2; i++)
        {
            ...
            for(j = 0; j < 2; j++)
            {
                ...
                m_temp_reg_0 = _mm_cvtepu8_epi16(m_temp_reg_0);
                m_temp_reg_45 = _mm_unpackhi_epi64(m_temp_reg_36, m_temp_reg_34);//bdfhjlnp1
                m_temp_reg_45 = _mm_add_epi16(m_temp_reg_45, m_temp_reg_0);
                ...
                m_temp_reg_0 = _mm_cvtepu8_epi16(m_temp_reg_0);
                m_temp_reg_46 = _mm_unpacklo_epi64(m_temp_reg_37, m_temp_reg_35);//bdfhjlnp2
                m_temp_reg_46 = _mm_add_epi16(m_temp_reg_46, m_temp_reg_0);
                ...
                m_temp_reg_0 = _mm_cvtepu8_epi16(m_temp_reg_0);
                m_temp_reg_47 = _mm_unpackhi_epi64(m_temp_reg_37, m_temp_reg_35);//bdfhjlnp3
                m_temp_reg_47 = _mm_add_epi16(m_temp_reg_47, m_temp_reg_0);
