 ...
 *  - ihevc_hbd_itrans_recon_4x4_ttype1()
 *  - ihevc_hbd_itrans_recon_4x4()
 *  - ihevc_hbd_itrans_recon_8x8()
 *
 * @remarks
 *  None
 *
...
void ihevc_hbd_itrans_recon_4x4_ttype1_sse42(WORD16 *pi2_src,
                                   WORD16 *pi2_tmp,
                                   UWORD16 *pu2_pred,
                                   UWORD16 *pu2_dst,
                                   WORD32 src_strd,
                                   ...
                                   UWORD8 bit_depth)
{
    ...
    /* Stage 2 */
    {
        ...
        /* Recon and store */
        {
            m_temp_reg_0 = _mm_loadl_epi64((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_1 = _mm_loadl_epi64((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_2 = _mm_loadl_epi64((__m128i *) pu2_pred);
            pu2_pred += pred_strd;
            m_temp_reg_3 = _mm_loadl_epi64((__m128i *) pu2_pred);
            ...
            _mm_storel_epi64((__m128i *)pu2_dst, m_temp_reg_20);
            pu2_dst += dst_strd;
            m_temp_reg_20 = _mm_srli_si128(m_temp_reg_20, 8);
            _mm_storel_epi64((__m128i *)pu2_dst, m_temp_reg_20);
            pu2_dst += dst_strd;
            _mm_storel_epi64((__m128i *)pu2_dst, m_temp_reg_21);
            pu2_dst += dst_strd;
            m_temp_reg_21 = _mm_srli_si128(m_temp_reg_21, 8);
            _mm_storel_epi64((__m128i *)pu2_dst, m_temp_reg_21);
            pu2_dst += dst_strd;
        }
    }
...
void ihevc_hbd_itrans_recon_4x4_sse42(WORD16 *pi2_src,
                                   WORD16 *pi2_tmp,
                                   UWORD16 *pu2_pred,
                                   UWORD16 *pu2_dst,
                                   WORD32 src_strd,
 ...
 *******************************************************************************
 */
void ihevc_hbd_itrans_recon_8x8_sse42(WORD16 *pi2_src,
                            WORD16 *pi2_tmp,
                            UWORD16 *pu2_pred,
                            UWORD16 *pu2_dst,
                            WORD32 src_strd,
    ...
    if (!check_row_stage_2)
    {
        ...
        i4_shift = 20 - bit_depth;
        {
            ...
            /* Recon and store */
            {
                ...
                pu2_pred += pred_strd;
                m_temp_reg_4 = _mm_loadu_si128((__m128i *) pu2_pred);
                pu2_pred += pred_strd;
                m_temp_reg_5 = _mm_loadu_si128((__m128i *) pu2_pred);
                pu2_pred += pred_strd;
                m_temp_reg_6 = _mm_loadu_si128((__m128i *) pu2_pred);
                pu2_pred += pred_strd;
                m_temp_reg_7 = _mm_loadu_si128((__m128i *) pu2_pred);
                ...
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_50);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_51);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_52);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_53);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_54);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_55);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_56);
                pu2_dst += dst_strd;
                _mm_storeu_si128((__m128i *)pu2_dst, m_temp_reg_57);
                pu2_dst += dst_strd;
            }
        }
    }
