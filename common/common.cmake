...
list(
  APPEND
  LIBHEVC_COMMON_SRCS
  "${HEVC_ROOT}/common/ihevc_bit_pack_unpack.c"
  "${HEVC_ROOT}/common/ihevc_chroma_iquant_itrans_recon_16x16.c"
  "${HEVC_ROOT}/common/ihevc_chroma_iquant_itrans_recon_8x8.c"
  "${HEVC_ROOT}/common/ihevc_chroma_resi.c"
  "${HEVC_ROOT}/common/ihevc_chroma_resi_quant.c"
  "${HEVC_ROOT}/common/ihevc_chroma_resi_trans.c"
  "${HEVC_ROOT}/common/ihevc_chroma_resi_trans_quant.c"
  "${HEVC_ROOT}/common/ihevc_debug.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_intra_pred_filters.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_iquant_itrans_recon.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_iquant_itrans_recon_16x16.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_iquant_itrans_recon_8x8.c"
  ...
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_resi.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_resi_quant.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_resi_trans.c"
  "${HEVC_ROOT}/common/ihevc_hbd_chroma_resi_trans_quant.c"
  ...
  "${HEVC_ROOT}/common/ihevc_hbd_iquant_itrans_recon.c"
  "${HEVC_ROOT}/common/ihevc_hbd_iquant_itrans_recon_16x16.c"
  "${HEVC_ROOT}/common/ihevc_hbd_iquant_itrans_recon_32x32.c"
  "${HEVC_ROOT}/common/ihevc_hbd_iquant_itrans_recon_8x8.c"
  ...
  "${HEVC_ROOT}/common/ihevc_hbd_quant.c"
  "${HEVC_ROOT}/common/ihevc_hbd_recon.c"
  "${HEVC_ROOT}/common/ihevc_hbd_resi.c"
  "${HEVC_ROOT}/common/ihevc_hbd_resi_quant.c"
  "${HEVC_ROOT}/common/ihevc_hbd_resi_trans.c"
  "${HEVC_ROOT}/common/ihevc_hbd_resi_trans_quant.c"
  "${HEVC_ROOT}/common/ihevc_hbd_sao.c"
  "${HEVC_ROOT}/common/ihevc_hbd_weighted_pred.c"
  "${HEVC_ROOT}/common/ihevc_inter_pred.c"
  "${HEVC_ROOT}/common/ihevc_iquant_itrans_recon_16x16.c"
  "${HEVC_ROOT}/common/ihevc_iquant_itrans_recon_32x32.c"
  "${HEVC_ROOT}/common/ihevc_iquant_itrans_recon_8x8.c"
  "${HEVC_ROOT}/common/ihevc_quant.c"
  "${HEVC_ROOT}/common/ihevc_resi.c"
  "${HEVC_ROOT}/common/ihevc_resi_quant.c"
  "${HEVC_ROOT}/common/ihevc_resi_trans_quant.c"
  "${HEVC_ROOT}/common/ihevc_trans.c")
...
if("${SYSTEM_PROCESSOR}" STREQUAL "aarch64" OR "${SYSTEM_PROCESSOR}" STREQUAL "arm64")
  list(
    ...
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_inter_pred_chroma_copy.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_inter_pred_chroma_copy_w16out.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_inter_pred_luma_copy.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_inter_pred_luma_copy_w16out.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_inter_pred_luma_horz_w16out.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_intra_pred_luma_dc.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_intra_pred_luma_horz.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_16x16.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_32x32.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_32x32_1.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_4x4.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_4x4_ttype1.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_itrans_recon_8x8.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_pad_left_chroma.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_pad_luma_left.s"
    "${HEVC_ROOT}/common/arm64/ihevc_hbd_pad_luma_right.s"
...
elseif("${SYSTEM_PROCESSOR}" STREQUAL "aarch32")
  ...
  list(
    ...
    "${HEVC_ROOT}/common/x86/ihevc_16x16_chroma_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_16x16_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_32x32_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_8x8_chroma_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_bit_pack_unpack_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_chroma_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_16x16_chroma_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_16x16_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_32x32_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_chroma_intra_pred_filters_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_chroma_itrans_recon_sse42_intr.c"
    ...
    "${HEVC_ROOT}/common/x86/ihevc_hbd_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_resi_trans_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_sao_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_hbd_tables_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_iquant_itrans_recon_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_quant_sse42_intr.c"
    "${HEVC_ROOT}/common/x86/ihevc_resi_trans_sse42_intr.c"
