...
void ihevc_hbd_chroma_resi_4x4(UWORD16 *pu2_src,
                           UWORD16 *pu2_pred,
                           WORD16 *pi2_dst,
                           WORD32 i4_src_strd,
                           WORD32 i4_pred_strd,
                           ...
                           WORD32 *pi4_csbf)
{
    ...
    for(i = 0; i < trans_size; i++)
    {
        ...
        {
            pi2_dst[j] = (pu2_src[j * 2] - pu2_pred[j * 2]);
        }
...
void ihevc_hbd_chroma_resi_8x8(UWORD16 *pu2_src,
                           UWORD16 *pu2_pred,
                           WORD16 *pi2_dst,
                           WORD32 i4_src_strd,
                           WORD32 i4_pred_strd,
...
void ihevc_hbd_chroma_resi_16x16(UWORD16 *pu2_src,
                             UWORD16 *pu2_pred,
                             WORD16 *pi2_dst,
                             WORD32 i4_src_strd,
                             WORD32 i4_pred_strd,
